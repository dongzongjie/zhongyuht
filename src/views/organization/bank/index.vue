  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="银行所在地" prop="bankLocation">
        <el-input
          v-model="queryParams.bankLocation"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['organization:bank:add']"
          >新增</el-button
        >
      </el-col>
      <!-- <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['organization:bank:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="银行所在地" align="center" prop="bankLocation" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除bank编号为"' + ids + '"的数据项?', '警告', {
